...
class NavigateBar(context: Context) : RelativeLayout(context) {
    ...
    private val titleView: TextView by lazy {
        ...
        tv.textSize = DimensAdapter.textSpSize(CustomTSDimens.BIGGER)
...
//    }
    ...
    fun setTitle(title: String, truncateAt: TextUtils.TruncateAt ?= TextUtils.TruncateAt.END, isBold: Boolean = false) {
        titleView.visibility = View.VISIBLE
        titleView.text = title
        titleView.ellipsize = truncateAt
        titleView.paint.isFakeBoldText = isBold
    }
...
//        }
     ...
     * @param btn
     */
    fun addRightLayoutBtn(btn: View) {
        var findLastLeftId = RIGHT_ID
...
//        btn.setBackgroundResource(R.drawable.navigate_btn)
    ...
    fun addRightTxt(text: String,textColor:Int,textSize:Float, listener: (View) -> Unit):TextView {
        val tv = TextView(context)
