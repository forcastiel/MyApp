...
import com.shrek.klib.ui.swipe.touch.DefaultItemTouchHelper;
import com.shrek.klib.ui.swipe.touch.OnItemMoveListener;
import com.shrek.klib.ui.swipe.touch.OnItemMovementListener;
import com.shrek.klib.ui.swipe.touch.OnItemStateChangedListener;
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                break;
            case MotionEvent.ACTION_MOVE:
                Log.e("aaaa","****** MotionEvent.ACTION_MOVE");
                if (mOldSwipedLayout != null && mOldSwipedLayout.isMenuOpen()) {
                    mOldSwipedLayout.smoothCloseMenu();
                }
                break;
