...
public class WheelView extends View {
     ...
     * 选中项文字颜色
     */
    private static final int VALUE_TEXT_COLOR = Color.parseColor("#35343D");

    /**
     * 未选中项文字颜色
     */
    private static final int ITEMS_TEXT_COLOR = Color.parseColor("#868686");
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 42;
     ...
     */
    private static final int ITEM_OFFSET = TEXT_SIZE / 5 - 6;
    ...
    private void initData(Context context) {
        ...
        TEXT_SIZE = (int) DimenUtils.dpToPx(14f, getContext());
    }
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            // TODO　：Paint.FAKE_BOLD_TEXT_FLAG
            ...
            if (useCurrentValue || i != currentItem) {
                ...
                if (text != null) {
                    if (!TextUtils.isEmpty(text)) {
                        if (text.length() > 25) {
                            char[] mByte = new char[28];
                            for (int ii = 0; ii < mByte.length; ii++) {
                                if (ii < 25) {
                                    mByte[ii] = text.charAt(ii);
                                } else {
                                    mByte[ii] = '.';
                                }
                            }
                    ...
                    if (!isDate && text.length() > 3) {
                        itemsText.append(text.substring(0, 3));
                    } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (itemsWidth > 0) {
            ...
            // if (density <= 1.5) {
            // canvas.translate(PADDING, 30);
            // }
            // if (density <= 2.0 && density > 1.5) {
            // canvas.translate(PADDING, 20 * density);
            // }
            //
            // if (density > 2.0) {
            // canvas.translate(PADDING, 120);
            // }
            drawItems(canvas); // �������ֵ
            drawValue(canvas); // ѡ�����ֵ
            canvas.restore();
        }
    ...
    //
    // bottomShadow
    // .setBounds(0, getHeight() - getHeight() / visibleItems, getWidth(),
    // getHeight());
...
//        itemsPaint.setTextSize(DimenUtils.dpToPx(18, getContext()));
    ...
    public void setLableOffest(int label_offset) {
