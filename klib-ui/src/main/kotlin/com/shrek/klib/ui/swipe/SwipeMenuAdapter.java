 ...
 */
package com.shrek.klib.ui.swipe;
 ...
 */
public abstract class SwipeMenuAdapter<HOLDER extends HolderBo> extends RecyclerView.Adapter<KHolder<HOLDER>> {
    ...
    @Override
    public final KHolder<HOLDER> onCreateViewHolder(ViewGroup parent, int viewType) {
        HOLDER holder = onCreateContentView(parent, viewType);
        View contentView = holder.rootView;
...
//                contentView = swipeMenuLayout;
                holder.rootView = swipeMenuLayout;
            }
        }
        return new KHolder<HOLDER>(holder);
    }
     ...
     */
    public abstract HOLDER onCreateContentView(ViewGroup parent, int viewType);

    @Override
    public final void onBindViewHolder(KHolder<HOLDER> holder, int position, List<Object> payloads) {
     ...
     */
    public void onCompatBindViewHolder(KHolder<HOLDER> holder, int position, List<Object> payloads) {
