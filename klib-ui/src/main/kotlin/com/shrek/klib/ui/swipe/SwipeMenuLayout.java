...
//        typedArray.recycle();
        ...
        mLeftViewId = R.id.swipe_left;
        mContentViewId = R.id.swipe_content;
        mRightViewId = R.id.swipe_right;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP: {
                Log.e("aaaa","!!!!!!!!!!!!!!!!!!!! MotionEvent.ACTION_UP");
            ...
            case MotionEvent.ACTION_CANCEL: {
                Log.e("aaaa","!!!!!!!!!!!!!!!!!!!! MotionEvent.ACTION_CANCEL");
                mDragging = false;
                if (!mScroller.isFinished()) {
                    mScroller.abortAnimation();
                } else {
